...
| Ferramentas de Software       | Ferramentas do Desenvolvedor (DevTools) e ferramentas de coleta e análise(5.2.2).  |
...
Com base nos problemas citados na sessão 5.2.1, o grupo optou por produzir uma ferramenta própria para a coleta de dados, onde conseguisse realizar tudo o que precisávamos sem depender de unir mais de um software ou pagar uma licença para uso da ferramenta.

## 7. Cronograma de Ações

| **Métrica**                                          | **Atividades Resumidas**                                                                                 | **Responsável(is)**                       | **Período**               |
| ---------------------------------------------------- | -------------------------------------------------------------------------------------------------------- | ----------------------------------------- | ------------------------- |
| **M1 – Cobertura de Requisitos Críticos por Módulo** | Levantamento de requisitos, rastreabilidade, análise de chamados, consolidação dos resultados            | **Laryssa, Matheus, Ana Beatriz**         | Dia 1-2 Semana 1          |
| **M2 – TIF (Inconformidade Funcional)**              | Coleta de comentários, análise de chamados, comparação com Portal da Transparência, cálculo final do TIF | **Giovana, Carlos, Matheus, Laryssa**     | Dia 1-2 Semana 1          |
| **M3 – TSCTC (Sucesso nas Tarefas Críticas)**        | Coleta de avaliações, análise de comportamento, acompanhamento de tentativas, cálculo da taxa de sucesso | **Ana Beatriz, Giovana, Carlos, Laryssa** | 3 a 5 dias Semana 1       |
| **M4 – TMEF / Disponibilidade**                      | 3 sessões de testes (dias diferentes) e consolidação dos dados                                           | **Matheus, Ana Beatriz, Carlos, Laryssa** | 3 dias distintos Semana 1 |
| **M5 – TMPR (Tempo para Reparo)**                    | Coleta de relatos de falhas, análise de notas de atualização, cálculo do TMPR                            | **Giovana, Matheus, Laryssa**             | 3 dias Semana 1           |
| **M6 – FFO (Frequência de Falhas)**                  | Coleta de avaliações, contagem de falhas, integração com sessões do M4, cálculo do FFO                   | **Ana Beatriz, Carlos, Giovana**          | Dia 1-2 Semana 1          |
| **Análise e Relatório**                              | Aplicação das pontuações GQM e redação do relatório final da Fase 3.                                     | **Todos**                                 | Dia 1-2 Semana 2          |

## 8. Garantia de Rastreabilidade e Reprodutibilidade
